//HintName: Generator.Equals.Runtime.DictionaryEqualityComparer.cs
using System;
...
namespace Generator.Equals
{
    internal class DictionaryEqualityComparer<TKey, TValue> : IEqualityComparer<IDictionary<TKey, TValue>>
    {
        class KeyPairEqualityComparer : IEqualityComparer<KeyValuePair<TKey, TValue>>
        {
            ...
            {
                return HashCode.Combine(obj.Key, obj.Value is null ? 0 : _valueEqualityComparer.GetHashCode(obj.Value));
            }
        }
