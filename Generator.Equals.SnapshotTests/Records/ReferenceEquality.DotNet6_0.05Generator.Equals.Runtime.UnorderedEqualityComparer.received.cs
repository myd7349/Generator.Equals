//HintName: Generator.Equals.Runtime.UnorderedEqualityComparer.cs
using System.Collections.Generic;
using System.Linq;

namespace Generator.Equals
{
    internal class UnorderedEqualityComparer<T> : IEqualityComparer<IEnumerable<T>> where T : notnull
    {
